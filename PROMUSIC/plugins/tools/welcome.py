...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("PROMUSIC/assets/welc2.png")
    ...
    draw.text((1230, 500), f'NAME: {user}', fill=(255, 255, 255), font=font)
    draw.text((1230, 570), f'ID: {id}', fill=(255, 255, 255), font=font)
    draw.text((1230, 640), f"USERNAME : @{uname}", fill=(255, 255, 255), font=font)
