...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    draw.text((624, 978), f'{user}', fill=(255, 255, 255), font=font)
    draw.text((415, 1150), f'{id}', fill=(255, 255, 255), font=font)
    draw.text((900, 1275), f"@{uname}", fill=(255, 255, 255), font=font)
