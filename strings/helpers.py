...
#paidsub
PAID_HELP = f"""
<b><u>ꜰᴇᴀᴛᴜʀᴇ ꜰᴏʀ ʙʀᴏᴀᴅᴄᴀsᴛ sᴜʙsᴄʀɪᴘᴛɪᴏɴ:</u></b>

ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ʙᴜʏ ʙʀᴏᴀᴅᴄᴀsᴛ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ꜰʀᴏᴍ ᴜs. ᴡᴇ ᴡɪʟʟ ɢɪᴠᴇ ʏᴏᴜ 4 ʙʀᴏᴀᴅᴄᴀsᴛ ꜰᴏʀ ᴀ ᴡᴇᴇᴋʟʏ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ᴡɪᴛʜ ᴛʜᴇ ʟɪᴍɪᴛ ᴏꜰ sᴇɴᴅɪɴɢ ʙʀᴏᴀᴅᴄᴀsᴛ ᴀꜰᴛᴇʀ ᴏɴᴇ ᴅᴀʏs. Tᴏ ʙᴜʏ ᴀ sᴜʙsᴄʀɪᴘᴛɪᴏɴ, ᴄᴏɴᴛᴀᴄᴛ @{OWNER_USERNAME}

<b><u>ᴏɴʟʏ ᴏᴡɴᴇʀ : </u></b>
/addsub [ᴜsᴇʀ_ɪᴅ] : Aᴅᴅ ᴀ ᴜsᴇʀ ᴛᴏ ᴛʜᴇ sᴜʙsᴄʀɪʙᴇʀ ʟɪsᴛ ᴡɪᴛʜ 𝟻 ᴘᴏɪɴᴛs ᴀɴᴅ ᴀ 𝟽-ᴅᴀʏ ᴇxᴘɪʀʏ. 
/rmsub [ᴜsᴇʀ_ɪᴅ] : Rᴇᴍᴏᴠᴇ ᴀ ᴜsᴇʀ ғʀᴏᴍ ᴛʜᴇ sᴜʙsᴄʀɪʙᴇʀ ʟɪsᴛ.
/sublist : Dɪsᴘʟᴀʏ ᴀ ʟɪsᴛ ᴏғ ᴀʟʟ ᴄᴜʀʀᴇɴᴛ sᴜʙsᴄʀɪʙᴇʀs.

<b><u>ᴀɴʏᴏɴᴇ ᴄᴀɴ ᴜsᴇ :</u></b>
/mysub : ʏᴏᴜ ᴄᴀɴ ᴄʜᴇᴋ ʏᴏᴜʀ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ᴡɪᴛʜ ʀᴇᴍᴀɪɴɪɴɢ ᴅᴀʏs ᴀɴᴅ ᴘᴏɪɴᴛs.
/paidbroadcast [ᴍᴇssᴀɢᴇ ᴏʀ ʀᴇᴩʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ] : ʙʀᴏᴀᴅᴄᴀsᴛ ᴀ ᴍᴇssᴀɢᴇ ᴛᴏ sᴇʀᴠᴇᴅ ᴄʜᴀᴛs ᴏғ ᴛʜᴇ ʙᴏᴛ.

<u>Mᴏʀᴇ ғᴇᴀᴛᴜʀᴇs ᴀᴅᴅᴇᴅ sᴏᴏɴ...</u>
"""

PAID_HELP_2 = f"""
<b><u>Sᴜʙsᴄʀɪᴘᴛɪᴏɴ Mᴀɴᴀɢᴇᴍᴇɴᴛ Cᴏᴍᴍᴀɴᴅs :</u></b>

<b><u>Oᴡɴᴇʀ Cᴏᴍᴍᴀɴᴅs : </u></b>
/addsub [ᴜsᴇʀ_ɪᴅ] : Aᴅᴅ ᴀ ᴜsᴇʀ ᴛᴏ ᴛʜᴇ sᴜʙsᴄʀɪʙᴇʀ ʟɪsᴛ ᴡɪᴛʜ 𝟻 ᴘᴏɪɴᴛs ᴀɴᴅ ᴀ 𝟽-ᴅᴀʏ ᴇxᴘɪʀʏ. 
/rmsub [ᴜsᴇʀ_ɪᴅ] : Rᴇᴍᴏᴠᴇ ᴀ ᴜsᴇʀ ғʀᴏᴍ ᴛʜᴇ sᴜʙsᴄʀɪʙᴇʀ ʟɪsᴛ.
/sublist : Dɪsᴘʟᴀʏ ᴀ ʟɪsᴛ ᴏғ ᴀʟʟ ᴄᴜʀʀᴇɴᴛ sᴜʙsᴄʀɪʙᴇʀs.
/pay [ᴜsᴇʀ_ɪᴅ] [ᴘᴏɪɴᴛs] : Aᴅᴅ ᴘᴏɪɴᴛs ᴛᴏ ᴀ ᴜsᴇʀ's ᴀᴄᴄᴏᴜɴᴛ.
/cut [ᴜsᴇʀ_ɪᴅ] [ᴘᴏɪɴᴛs] : Rᴇᴍᴏᴠᴇ ᴘᴏɪɴᴛs ғʀᴏᴍ ᴀ ᴜsᴇʀ's ᴀᴄᴄᴏᴜɴᴛ.

<b><u>Cᴏɴᴛᴀᴄᴛ ғᴏʀ Sᴜʙsᴄʀɪᴘᴛɪᴏɴ : </u></b>
Tᴏ ʙᴜʏ ᴀ sᴜʙsᴄʀɪᴘᴛɪᴏɴ, ᴄᴏɴᴛᴀᴄᴛ @{OWNER_USERNAME}

<b><u>Sᴜʙsᴄʀɪʙᴇʀs Cᴏᴍᴍᴀɴᴅs :</u></b>
/mysub : Cʜᴇᴄᴋ ʏᴏᴜʀ sᴜʙsᴄʀɪᴘᴛɪᴏɴ sᴛᴀᴛᴜs, ᴘᴏɪɴᴛs, ᴀɴᴅ ᴇxᴘɪʀʏ ᴅᴀᴛᴇ.
